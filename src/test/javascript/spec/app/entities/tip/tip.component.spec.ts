...
describe('Component Tests', () => {
    describe('Tip Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.tips[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
